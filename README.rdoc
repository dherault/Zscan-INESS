INESS handles NFC cashless payments in events.

Stack : Rails 4, knockout.js & jQuery

(feu) INESS, formerly known as Zscan is suppose to work with NFC cards or wristbands and in-house hardware for order processing (a pi with a nfc reader and a touch screen).

Functionnalities : 
- Card refil and bar checkout
- Endpoints and Products administration
- Remote stock administration
